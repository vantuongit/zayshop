<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <div class="sidebar content-box" style="display: block;">
				...
				<ul class="nav">
				    ...
				    <li><a href="${pageContext.request.contextPath}/admin/news/index"><i class="glyphicon glyphicon-book"></i> Tin</a></li>
				    <li><a href="${pageContext.request.contextPath}/admin/user/index"><i class="glyphicon glyphicon-plus"></i> User</a></li>
				    <li><a href="${pageContext.request.contextPath}/admin/contact/index"><i class="glyphicon glyphicon-list"></i>Liên hệ</a></li>
				    <li class="submenu">
				         <a href="#">
