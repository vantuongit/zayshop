...
<style type="text/css">
@import
	url("https://fonts.googleapis.com/css?family=Share+Tech+Mono|Montserrat:700")
	;
...
<div>
	...
	<p>
		> <span>SOME PAGES ON THIS SERVER THAT YOU DO HAVE PERMISSION
			TO ACCESS</span>: [<a href="${pageContext.request.contextPath}/admin/index">Home
			Page</a>, <a href="${pageContext.request.contextPath}/admin/cat/index">Category
			Page</a>, <a href="${pageContext.request.contextPath}/admin/news/index">News
			Page</a>, <a href="${pageContext.request.contextPath}/admin/contact/index">Contact Page</a>...]
	</p>
	<p>
