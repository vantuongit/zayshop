	...
	<div class="carousel-inner">
			...
			<div class="container">
				<div class="row p-5">
					<div class="mx-auto col-md-8 col-lg-6 order-lg-last">
						<img class="img-fluid" src="${contextPath }/img/banner_img_01.jpg"
							alt="">
					</div>
		...
		<div class="carousel-item">
			<div class="container">
				<div class="row p-5">
					<div class="mx-auto col-md-8 col-lg-6 order-lg-last">
						<img class="img-fluid" src="${contextPath }/img/banner_img_02.jpg"
							alt="">
					</div>
					<div class="col-lg-6 mb-0 d-flex align-items-center">
		...
		<div class="carousel-item">
			<div class="container">
				<div class="row p-5">
					<div class="mx-auto col-md-8 col-lg-6 order-lg-last">
						<img class="img-fluid" src="${contextPath }/img/banner_img_03.jpg"
							alt="">
					</div>
					<div class="col-lg-6 mb-0 d-flex align-items-center">
						<div class="text-align-left">
					...
					<c:forEach items="${ProductsList }" var="item">
						<div class="col-12 col-md-4 mb-4">
							<div class="card h-100">
								<a href="${pageContext.request.contextPath}/detail/${item.pid}"> <img
								...
								<div class="card-body">
									...
									<a href="${pageContext.request.contextPath}/detail/${item.pid}"
										class="h2 text-decoration-none text-dark">${item.pname}</a>
									<p class="card-text">${item.detail }</p>
									<p class="text-muted">Views (${item.count_views})</p>
								</div>
							</div>
						</div>
